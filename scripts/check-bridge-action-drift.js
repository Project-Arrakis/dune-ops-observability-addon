...
function extractCodeActions(repoRoot = DEFAULT_REPO_ROOT) {
  ...
  const src = fs.readFileSync(
    path.join(repoRoot, 'web/data-providers.js'), // nosemgrep
    'utf8'
  );
...
function extractReadmeActions(repoRoot = DEFAULT_REPO_ROOT) {
  // Same rationale as extractCodeActions above: repoRoot is never
  // attacker/user-controlled.
  const readme = fs.readFileSync(path.join(repoRoot, 'README.md'), 'utf8'); // nosemgrep
